...
const CEO_MONEY_FIELDS: FieldDef[] = [
  ...
  {
    key: "usdRateHKD",
    label: "HKD → USD (direct)",
    type: "number",
    min: 0,
    step: 0.0001,
    defaultValue: 0.127,
    help: "HKD is pegged to the US dollar (~7.87 HKD/USD). This direct rate is used instead of converting HKD via SGD, which would compound two rates. Leave at the peg unless it moves.",
  },
